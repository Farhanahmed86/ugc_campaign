<template>
  <div class="contanir">
    ...
    <div class="col">
      <h4 style="font-weight: 400;color: #000;padding-left: 25px;">Dites-en nous plus sur vos clients</h4>
    </div>
    <div class="row" style="display: flex;flex-direction: column;align-content: center;justify-content: center;gap: 50px; padding-top: 50px;">
      <div class="col">
        <div class="row" style="display: flex;flex-direction: column;justify-content: center;align-content: center;">
          <div class="col">
            <h5 style="color: #2A2C76; font-weight: 400; text-align: center;">Où est situé votre clientèle cible ?</h5>
          </div>
          <div class="col">
            <div class="row" style="display: flex;    justify-content: space-between;align-items: center;padding-top:30px">
              <div class="col-2">
                  <div class="card" style="width: 100%;border: none;border-radius: 12px;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;" @click="flags('morocco')">
                    ...
                    <div class="card-body" @click="datas('Maroc' , 1)" style="display: flex;flex-direction: column;align-items: center;gap: 10px;padding: 15px 0px 0px 0px;">
                    <div class="img" style="display: flex;justify-content: center;align-items: center;">
                      <img src="/images/nf1.png" style="width: 75%;"/>
                    </div>
                      <h5 class="card-title" style="font-size: 18px;color: #000;font-weight: 200;">Maroc</h5>
                  </div>
                </div>
                </div>
              </div>
                ...
                <div class="card" style="width: 100%;border: none;border-radius: 12px;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;" @click="flags('ivory-coast')">
                  ...
                  <div class="card-body" style="display: flex;flex-direction: column;align-items: center;gap: 10px;padding: 15px 0px 0px 0px;">
                    <div class="img" style="display: flex;justify-content: center;align-items: center;">
                      ...
                      <h5 class="card-title" style="font-size: 18px;color: #000;font-weight: 200;">Côte d'ivoire</h5>
                  </div>
                </div>
              </div>
              </div>
              <div class="col-2">
                  <div class="card" style="width: 100%;border: none;border-radius: 12px;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;" @click="flags('spain')">
                    <div class="main-card" @click="datas('Espagne' , 3)" :style="{ backgroundColor: bgColor3 }">
                    <div class="card-body" style="display: flex;flex-direction: column;align-items: center;gap: 10px;padding: 15px 0px 0px 0px;">
                    <div class="img" style="display: flex;justify-content: center;align-items: center;">
                      <img src="/images/nf3.png" style="width: 75%;"/>
                    </div>
                      <h5 class="card-title" style="font-size: 18px;color: #000;font-weight: 200;">Espagne</h5>
                  </div>
                </div>
                </div>
              </div>
              <div class="col-2">
                <div class="card" style="width: 100%;border: none;border-radius: 12px;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;" @click="flags('tunisia')">
                  <div class="main-card" @click="datas('Tunisie' , 4)" :style="{ backgroundColor: bgColor4 }">
                  <div class="card-body" style="display: flex;flex-direction: column;align-items: center;gap: 10px;padding: 15px 0px 0px 0px;">
                    <div class="img" style="display: flex;justify-content: center;align-items: center;">
                      <img src="/images/nf4.png" style="width: 75%;"/>
                    </div>
                      <h5 class="card-title" style="font-size: 18px;color: #000;font-weight: 200;">Tunisie</h5>
                  </div>
                </div>
              </div>
              </div>
      ...
      <div class="col">
        <div class="row" style="display: flex;flex-direction: column;justify-content: center;align-content: center;">
          <div class="col">
            <h5 style="color: #2A2C76; font-weight: 400; text-align: center;">Quel est l'age de votre clientèle ?</h5>
          </div>
          <div class="col">
            ...
            <div class="col">
              <h5 style="color: #000;font-weight: 400; text-align: center;">Quel est le genre de votre clientèle ?</h5>
            </div>
          </div>
        </div>
        <div class="col">
          <div class="row" style="display: flex;justify-content: center;gap: 50px;align-items: center;padding-top: 10px;">
            <div class="col_3">
              <div class="card" style="width: 100%;border: none;border-radius: 10px;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;" @click="gender('Homme')">
                ...
                <div class="card-body" style="display: flex;flex-direction: column;align-items: center;padding: 5px 85px 0px 85px;gap: 5px;">
                    <div class="img" style="display: flex;justify-content: center;align-items: center;">
                      ...
                      <h5 class="card-title" style="font-size: 18px;color: #000;font-weight: 200;">Homme</h5>
                  </div>
                </div>
             </div>
            </div>
            <div class="col_3"> 
              <div class="card" style="width: 100%;border: none;border-radius: 10px;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;" @click="gender('Femme')">
                <div class="short-card" @click="atas('ivory-coast' , 2)" :style="{ backgroundColor: bmColor2 }">  
                <div class="card-body" style="display: flex;flex-direction: column;align-items: center;padding: 5px 85px 0px 85px;gap: 5px;">
                    <div class="img" style="display: flex;justify-content: center;align-items: center;">
                      <img src="/images/f1.png" style="width: 75%;"/>
                    </div>
                      <h5 class="card-title" style="font-size: 18px;color: #000;font-weight: 200;">Femme</h5>
                  </div>
                </div>
             </div>
            </div>
            <div class="col_3">
              <div class="card" style="width: 100%;border: none;border-radius: 10px;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;" @click="gender('Les deux')">
                 <div class="short-card" @click="atas('ivory-coast' , 3)" :style="{ backgroundColor: bmColor3 }">  
                <div class="card-body" style="display: flex;flex-direction: column;align-items: center;padding: 5px 85px 0px 85px;gap: 5px;">
                    <div class="img" style="display: flex;justify-content: center;align-items: center;">
                      <img src="/images/f3.png" style="width: 75%;"/>
                    </div>
                      <h5 class="card-title" style="font-size: 18px;color: #000;font-weight: 200;">Les deux</h5>
                  </div>
                </div>
            </div>
            </div>
      ...
      <div class="col">
        <div class="row" style="display: flex;flex-direction: column;justify-content: center;align-content: center;">
          <div class="col">
            <h5 style="color: #2A2C76; font-weight: 400; text-align: center;">Qu'est-ce qui pourrait intéresser votre clientèle ?</h5>
          </div>
          <div class="col">
            <div class="row" style="display: flex;flex-wrap: wrap;align-items: center;gap: 30px 0px;padding-top: 30px;">
              <div class="col-3">
                <div class="card" style="width: 100%;border: none;border-radius: 10px;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;" @click="campaign('Sport')">
                  ...
                  <h5 class="card-title" style="font-size: 18px;color: #000;font-weight: 200;">Sport</h5>
                  </div>
                </div>
              </div>
              <div class="col-3">
                <div class="card" style="width: 100%;border: none;border-radius: 10px;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;" @click="campaign('Gaming & Technology')">
                  ...
                  <h5 class="card-title" style="font-size: 18px;color: #000;font-weight: 200;">Gaming & Technology</h5>
                </div>
                </div>
              </div>
              <div class="col-3">
                <div class="card" style="width: 100%;border: none;border-radius: 10px;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;" @click="campaign('Beauté & Cosmétique')">
                  ...
                  <h5 class="card-title" style="font-size: 18px;color: #000;font-weight: 200;">Beauté & Cosmétique</h5>
                </div>
                </div>
              </div>
              <div class="col-3">
                <div class="card" style="width: 100%;border: none;border-radius: 10px;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;" @click="campaign('Art de vivre')">
                  ...
                  <h5 class="card-title" style="font-size: 18px;color: #000;font-weight: 200;">Art de vivre</h5>
                </div>
                </div>
              </div>
              <div class="col-3">
                <div class="card" style="width: 100%;border: none;border-radius: 10px;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;" @click="campaign('Voyage & Hotellerie')">
                  ...
                  <h5 class="card-title" style="font-size: 18px;color: #000;font-weight: 200;">Voyage & Hotellerie</h5>
                </div>
                </div>
              </div>
              <div class="col-3">
                <div class="card" style="width: 100%;border: none;border-radius: 10px;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;" @click="campaign('Nourriture & Boisson')">
                  ...
                  <h5 class="card-title" style="font-size: 18px;color: #000;font-weight: 200;">Nourriture & Boisson</h5>
                </div>
                </div>
              </div>
              <div class="col-3">
                <div class="card" style="width: 100%;border: none;border-radius: 10px;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;" @click="campaign('Mode & Luxe')">
                  ...
                  <h5 class="card-title" style="font-size: 18px;color: #000;font-weight: 200;">Mode & Luxe</h5>
                </div>
                </div>
              </div>
              <div class="col-3">
                <div class="card" style="width: 100%;border: none;border-radius: 10px;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;" @click="campaign('Décoration & Enfants')">
                  ...
                  <h5 class="card-title" style="font-size: 18px;color: #000;font-weight: 200;">Décoration & Enfants</h5>
                </div>
                </div>
              </div>
            </div>
