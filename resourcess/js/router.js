...
let router = new Router({
    ...
    routes: [
        ...
        {
            path: "/influencer_singup/:id",
            name: "register",
            component: () => import("./views/register/influencer.vue")
        },

        {
            path: "/influencer_accounts/:id",
            name: "register",
            component: () => import("./views/register/influencer_account.vue")
        },

        {
            path: "/influencer_uploads/:id",
            name: "register",
            component: () => import("./views/register/influencer_upload.vue")
        },
        {
...
{path: '/invited', component: require('./views/admin/invited_influncers.vue').default,
meta: {
...
meta: {
    ...
    meta: {
        ...
        layout: AdminLayout
                ...
                {path: '/brand_details/:id', component: require('./views/admin/brand_details.vue').default,
                meta: {
                ...
                {path: '/brand_detail/:id', component: require('./views/admin/brand_details_influencer.vue').default,
                meta: {
                ...
                {path: '/no_suggestion', component: require('./views/admin/no_sugestion.vue').default,
                meta: {
                ...
                {path: '/compaigns_ucg/:id', component: require('./views/admin/compaign_UCG_id.vue').default,
                meta: {
                ...
                {path: '/influencer_suggest/:id', component: require('./views/admin/influencer_suggest.vue').default,
                meta: {
                ...
                {path: '/influencerdashboard', component: require('./views/admin/influencer_dashboard.vue').default,
                meta: {
                ...
                {path: '/creators/:id', component: require('./views/admin/creators.vue').default,
                meta: {
                ...
                meta: {
                 ...
                 {path: '/portfolio/:id', component: require('./views/admin/portfolio.vue').default,
                meta: {
