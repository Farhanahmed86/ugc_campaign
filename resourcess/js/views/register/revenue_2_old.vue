        ...
        <div class="container-1">
            ...
            <form action="/action_page.php">
                <div class="form-group">
                    <div class="row">
                        <div class="col">
                            <div class="card"><div class="card-body">Someone recommended me</div></div>
                            <div class="card"><div class="card-body">Google / Bing</div></div>
                            <div class="card"><div class="card-body">Insense Blog</div></div>
                            <div class="card"><div class="card-body">Newsletter</div></div>
                            <div class="card"><div class="card-body">Event</div></div>
                            <div class="card"><div class="card-body">Insenseteam reached out to me</div></div>
                        </div>
                    </div>
                </div>
