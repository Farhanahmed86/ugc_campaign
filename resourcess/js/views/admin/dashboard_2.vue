<template>
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div class="row">
            <div class="col-6">
                <h2 style="color: black;">Where would you like to start?</h2>
                <span style="color: black;">You can choose any type of campaingn</span    >
<br>
<br>
            ...
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                ...
                <div class="h5 text-xs mb-0 text-gray-800">
                 <span>Produce Authentic UCG ad creatives for your paid socail channel</span>
                </div>
