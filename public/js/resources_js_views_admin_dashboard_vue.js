...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  beforeRouteEnter: function beforeRouteEnter(to, from, next) {
    (0,_lib_api__WEBPACK_IMPORTED_MODULE_2__.get)('/api/dashboard', to.query).then(function (res) {
      next(function (vm) {
  ...
  methods: {
    detailsPage: function detailsPage(item) {
      this.$router.push("/dashboard/".concat(item.id));
    },
    setData: function setData(res) {
      vue__WEBPACK_IMPORTED_MODULE_3__.default.set(this.$data, 'model', res.data.results); //this.page = this.model.current_page
