...
var render = function() {
  ...
  return _c("div", { staticClass: "black" }, [
    _c("div", { staticClass: "container" }, [
      ...
      _vm._m(0),
      _vm._v(" "),
      _c("h5", { staticClass: "text-center", staticStyle: { color: "cyan" } })
    ]),
    _vm._v(" "),
    _c(
      "div",
      ...
      [
        _c(
          "router-link",
          {
            ...
            staticStyle: {
              background:
                "linear-gradient(49deg, rgba(0,0,0,1) 0%, rgba(0,0,1,1) 7%, rgba(7,11,34,1) 32%, rgba(11,37,37,1) 73%, rgba(116,32,96,1) 100%)"
            },
            attrs: { to: "/login" }
          },
          [
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      "h1",
      { staticClass: "text-center", staticStyle: { color: "cyan" } },
      [
        _c("span", { staticStyle: { "font-weight": "bold" } }, [
          _vm._v("Copyright © Brand Revam\n      ")
        ])
      ]
    )
  }
